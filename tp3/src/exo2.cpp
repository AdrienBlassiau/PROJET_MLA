...
int main(int argc, char const *argv[])
{
    ...
    cutPlanes.runCutPlanes(iters, time1);    //renvoie 0 si échec
    ...
    cout<<endl;
    cout<<"Temps d'execution : "<<time1<<endl;
    ...
    //Faire tourner les plans coupants
    cutPlanes.runCutPlanes(iters, time2);    //renvoie 0 si échec
    finalObj = cutPlanes.getObjVal();
    ...
    cout<<endl;
    cout<<"Temps d'execution : "<<time2<<endl;
    printf("FIN ETAPE 2\n");

    cout<<"Temps d'execution total: "<<time1+time2<<endl;
